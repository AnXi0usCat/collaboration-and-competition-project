...
# Collaboration and Competition - RL Project - Udacity
...
Download the the environment from one of the links below.
...
3. To start training, simply open *Tennis.ipynb* in Jupyter Notebook and follow the instructions there:
